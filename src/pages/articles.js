...
import article1 from "../../public/images/articles/installing-cypress.jpg";
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Muhammad Okky Irawan | Articles</title>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light ">
        <Layout className="pt-16 ">
          ...
          <ul className="grid grid-cols-2 gap-16 md:grid-cols-1 md:gap-y-16 2xl:mx-16 md:mx-0">
            <FeatureArticle
              title="How To Installasi Cypress?"
              summary="learn how to install Cypress for end-to-end automation testing."
              time="9 min read"
              img={article1}
              link="https://rod-news.blogspot.com/2023/08/how-to-instalasi-cypress.html"
            />
            {/* <FeatureArticle
